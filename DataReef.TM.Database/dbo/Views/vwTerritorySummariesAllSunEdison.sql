...
CREATE view [dbo].[vwTerritorySummariesAllSunEdison]
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[vwTerritorySummariesAllSunEdison] TO [sunedison]
    AS [dbo];


GO
GRANT SELECT
    ON OBJECT::[dbo].[vwTerritorySummariesAllSunEdison] TO [reportingadmin]
    AS [dbo];
