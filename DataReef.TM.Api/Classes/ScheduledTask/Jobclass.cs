...
namespace DataReef.TM.Api.Classes.ScheduledTask
{
    public class Jobclass : Quartz.IJob
    {
        public void Execute(Quartz.IJobExecutionContext context)
        {
            ...
            {
                var List = dc.Database.SqlQuery<DeactivateUserModel>("exec usp_DeactivateUserByLoginDays").FirstOrDefault();

                string mailbody = "Ignite Users : "  + List.IgniteName + "  Smartboard Users : " + List.SbName; 
