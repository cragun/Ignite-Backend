...
namespace DataReef.TM.Api.Areas.HelpPage.Services.SampleGeneration.ObjectGenerator
{
    ...
    /// </summary>
    [Service("DefaultObjectGenerator", typeof(IObjectGenerator))]
    public class DefaultObjectGenerator : IObjectGenerator
    {
        ...
        private static object GenerateTuple(Type type, Dictionary<Type, object> createdObjectReferences)
        {
            ...
            DefaultObjectGenerator objectGenerator = new DefaultObjectGenerator();
